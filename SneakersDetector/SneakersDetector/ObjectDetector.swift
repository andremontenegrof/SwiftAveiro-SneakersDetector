...
fileprivate extension ObjectDetector {
    ...
    func predictions(from features: [VNCoreMLFeatureValueObservation],
        ...
        // After returning the capped orderedPredictions array you'll have completed the first part of our workshop 🎉! Take the time to explore this codebase, try the app with `liveCamera` mode or take a change at the Bonus Step.
